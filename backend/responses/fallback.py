data = {
    "answers": {
        "en": [
            ...
            "I might need a bit more context on that, but I can definitely help you navigate my projects or explain my coding philosophy!",
            "I don't have an answer for that yet, but I'm an expert on my own work history! Ask me about my experience or my stack.",
        ],
        "es": [
            ...
            "Puede que necesite un poco más de contexto, ¡pero definitivamente puedo ayudarte a navegar por mis proyectos o explicarte mi filosofía de programación!",
            "Aún no tengo una respuesta para eso, ¡pero soy un experto en mi propia historia laboral! Pregúntame sobre mi experiencia o mi stack.",
        ],
        "fr": [
            ...
            "J'aurais peut-être besoin d'un peu plus de contexte, mais je peux certainement vous aider à naviguer dans mes projets ou vous expliquer ma philosophie de codage !",
            "Je n'ai pas encore de réponse à cela, mais je suis un expert de mon propre parcours professionnel ! Interrogez-moi sur mon expérience ou mon stack.",
        ],
    }
}
