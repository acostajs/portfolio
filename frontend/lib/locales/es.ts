...
export const es: TranslationType = {
  ...
  admin: {
    ...
    chatbot: {
      ...
      priority: "Prioridad (Mayor = más probable de coincidir)",
    ...
    analytics: {
      title: "Análisis del Portafolio",
      recentMessages: "Conversaciones en Vivo",
      recentFeedback: "Bucle de Retroalimentación",
      helpful: "Útil",
      notHelpful: "No Útil",
      noData: "Esperando datos de visitantes...",
      tabs: {
        chat: "Conversaciones",
      ...
      stats: {
        ...
        totalFeedback: "Feedback Recibido",
        helpfulRatio: "Tasa de Éxito",
        totalViews: "Impresiones Totales",
        uniqueVisitors: "Usuarios Únicos",
        chatSessions: "Sesiones Interactivas",
      },
      activity: {
        popularContent: "Contenido de Alto Tráfico",
        views: "impresiones",
      },
      health: {
        backendInfra: "Infraestructura Núcleo",
        systemResources: "Métricas de Recursos",
        database: "Capa de Datos",
        memoryUsage: "Carga de Memoria",
