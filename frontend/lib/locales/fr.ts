...
export const fr: TranslationType = {
  ...
  home: {
    ...
    liveChatPlaceholder: "En direct avec Juan...",
    escalateToLiveChat: "Parler directement avec le développeur",
    closeLiveChat: "Quitter le chat en direct",
    features: [],
    ...
    commands: {
      ...
      list: [
        ...
        {
          cmd: "/live-chat",
          desc: "Discutez en temps réel avec le développeur.",
        },
        { cmd: "/close-live-chat", desc: "Revenir au mode assistant IA." },
      ],
    },
  },
  header: {
  ...
  admin: {
    ...
    chatbot: {
      ...
      priority: "Priorité (Plus élevé = plus de chances de correspondre)",
    ...
    analytics: {
      title: "Analytique du Portfolio",
      recentMessages: "Conversations en Direct",
      recentFeedback: "Boucle de Rétroaction",
      helpful: "Utile",
      notHelpful: "Inutile",
      noData: "En attente de données visiteurs...",
      tabs: {
        chat: "Conversations",
        activity: "Engagement",
      ...
      stats: {
        ...
        totalFeedback: "Retours Reçus",
        helpfulRatio: "Taux de Réussite",
        totalViews: "Impressions Totales",
        uniqueVisitors: "Utilisateurs Uniques",
        chatSessions: "Sessions Interactives",
      },
      activity: {
        popularContent: "Contenu à Fort Trafic",
        views: "impressions",
      },
      health: {
        backendInfra: "Infrastructure Cœur",
        systemResources: "Métriques Ressources",
        database: "Couche de Données",
        memoryUsage: "Charge Mémoire",
